...
public class Main
{
    ...
    // Most of the times because you don't know how many times you want to loop ahead of time.
    public static void main(String[] args)
    {
        ...
        // Do While loop
        // This type of loop has the advantage that it will always execute at least once.
        ...
        do // Guaranteed to execute at least once.
        {
            ...
            // "break" inside the "do while" loop is alo possible.
            if (count > 100)
            {
                break;
            }
