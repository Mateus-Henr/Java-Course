...
public class ImprovedOne
{
    ...
    private static void displayHighScorePosition(Map<Integer, Map<String, Integer>> players,
                                                 Map<Integer, Integer> highScorePositions)
    {
        for (int i = 0; i < players.size(); i++)
        {
            System.out.println("The player named as " + players.get(i).keySet().toArray()[0] +
                                       " managed to get into position " + highScorePositions.get(i) +
